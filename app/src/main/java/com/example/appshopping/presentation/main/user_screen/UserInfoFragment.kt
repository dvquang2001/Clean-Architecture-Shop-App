...
import com.example.appshopping.databinding.LayoutDialogChangePasswordBinding
import com.example.appshopping.databinding.LayoutDialogGenderBinding
import com.example.appshopping.databinding.LayoutDialogLogoutBinding
import com.example.appshopping.databinding.LayoutDialogNameBinding
...
class UserInfoFragment :
    ...
    private fun showChangePasswordScreen() {
        ...
        dialogChangePasswordBinding.btnChange.setOnClickListener {
            ...
            viewModel.onEvent(UserInfoViewModel.ViewEvent.ChangePassword(
