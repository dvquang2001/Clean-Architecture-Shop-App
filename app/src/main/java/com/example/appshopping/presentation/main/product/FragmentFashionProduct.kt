...
import com.example.appshopping.databinding.FragmentFashionProductBinding
...
@AndroidEntryPoint
class FragmentFashionProduct: BaseFragment<FragmentFashionProductBinding, ProductViewModel>(R.layout.fragment_fashion_product) {
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.state.collect { state ->
                    ...
                    binding.rcvFashionProduct.adapter = productAdapter
                }
            }
        }
    }
    ...
    override fun initData() {
        viewModel.onEvent(ProductViewModel.ViewEvent.ShowFashionProduct)
    }
}