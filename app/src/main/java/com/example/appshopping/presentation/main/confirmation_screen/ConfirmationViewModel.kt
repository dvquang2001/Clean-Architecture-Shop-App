...
@HiltViewModel
class ConfirmationViewModel @Inject constructor(private val getProductsByUserIdUseCase: GetProductsByUserIdUseCase) :
    BaseViewModel<ConfirmationViewModel.ViewState, ConfirmationViewModel.ViewEvent, ConfirmationViewModel.ViewEffect>(
        ViewState()
    ) {
